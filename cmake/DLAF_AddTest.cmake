...
function(DLAF_addTest test_target_name)
  set(options "")
  set(oneValueArgs MPIRANKS USE_MAIN TEST_GROUP)
  ...
  if (DLAF_AT_TEST_GROUP)
    set(test_group_name ${DLAF_AT_TEST_GROUP})
  else()
    set(test_group_name ${test_target_name})
  endif()
  message("${test_group_name}")
  ...
  if(DLAF_COMBINE_TESTS)
    set(test_target_name ${test_group_name})
